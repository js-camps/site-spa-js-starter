    ...
    <div>
      ...
      <div>
        <p>
          ...
          Notice that we&lsquo;re importing the entire form group from the `index.js`
          file found within that directory. This pattern will help you break
          down your features in terms of components. Once you&lsquo;re read, organize
          your components inside a &lsquo;container&lsquo; and simply use the `index.js`
